...
import { returnPage, logout, getDb, addDocument } from "../firebase-app.js";
...
async function showData() {
    try {
        ...
        const cards = document.querySelectorAll(".card-class"); // Obtener todas las cards con la clase card-class
        cards.forEach((card) => {
