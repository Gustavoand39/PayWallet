    ...
    async function getData() {
        try {
            ...
            for (const docID in dataObject) {
                ...
                const { nombre, categoria, precio, stock, url } = docData; // Obtener los datos del platillo

                dishes[docID] = [categoria, nombre, precio, stock, url];
